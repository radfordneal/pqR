...
assign(".el.methods", function(x, ...) NULL, envir = .ArgsEnv)
...
assign("gradient_of", function(e) NULL, envir = .ArgsEnv)
...
assign("no_gradient", function (e) NULL, envir = .ArgsEnv)
...
assign("pnamedcnt", function(x,...) NULL, envir = .ArgsEnv)
