...
SEXP do_eval(SEXP, SEXP, SEXP, SEXP, int);
...
SEXP do_get_rm(SEXP, SEXP, SEXP, SEXP, int);
...
SEXP do_nextmethod(SEXP,SEXP,SEXP,SEXP,int);
...
SEXP do_testvalgrind(SEXP, SEXP, SEXP, SEXP);
...
SEXP do_usemethod(SEXP, SEXP, SEXP, SEXP, int);
